  ...
  if (!CONCIERGE_NUMBER) {
    return (
      <p className="sms-concierge-cta sms-concierge-cta--no-number">
        Text <strong>FIKA</strong> or <strong>HI</strong> to the Fika number to get your first intro and opt in for the week. (Check your account or welcome email for the number.)
      </p>
    )
  }
  return (
