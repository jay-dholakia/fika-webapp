  ...
  return (
    <>
      ...
      <main className="legal-page">
        ...
        <p><strong>SMS with the Fika concierge.</strong> We store the content of your SMS conversations with the Fika concierge (e.g. opt-in replies, scheduling replies) and use it to run the service, send you intros and meetup details, and for safety and support where needed.</p>
        ...
        <ul>
          ...
          <li>To run the Fika concierge—SMS opt-in, introductions, scheduling, and meetup coordination—and to communicate with you via SMS for intros and coordination</li>
