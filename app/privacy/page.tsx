  ...
  return (
    <>
      ...
      <main className="legal-page">
        ...
        <p><strong>Account and sign-in.</strong> You sign in to Fika via our website using Google or another method we offer. We collect your phone number separately so we can send SMS introductions, intro details, and meetup coordination. We do not use your phone number for sign-in verification.</p>
        ...
        <p><strong>Intros.</strong> We use your profile and preferences to find good Fika intros. When relevant, we use your SMS replies (e.g. accept/pass, Yes or No to an intro), your responses, and intro status to provide introductions and improve who we suggest.</p>
        ...
        <ul>
          ...
          <li>To run SMS introductions and meetup coordination—and to communicate with you via SMS for intros and coordination</li>
