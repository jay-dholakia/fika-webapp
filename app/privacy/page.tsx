  ...
  return (
    <>
      ...
      <main className="legal-page">
        ...
        <p><strong>Account and profile.</strong> When you sign up, we collect your email, name (if you provide it), and any profile details you add—such as photo, bio, interests, and city or region—so we can run the service and personalize your experience.</p>
        ...
        <ul>
          <li>To run accounts, matching, and in-app messaging</li>
        ...
        <p><strong>With other users.</strong> Your profile and other details you choose to share are visible to people we introduce you to. Message content is visible to the person you’re messaging.</p>
        <p><strong>Service providers.</strong> We use trusted partners for hosting, email, analytics, and similar services. They process data on our behalf under strict agreements.</p>
        ...
        <h2>Your rights</h2>
        <p>You can access, correct, or delete your data through the app or by contacting us. You can export your data and opt out of marketing emails. If you’re in the EU or UK, you have additional rights, including to object to certain processing and to lodge a complaint with a supervisory authority.</p>

        <h2>Security</h2>
        <p>We use industry-standard measures to protect your data. No system is completely secure; we encourage you to use a strong password and be careful with what you share.</p>
        ...
        <h2>Changes</h2>
        <p>We may update this policy from time to time. We’ll post the new version here and, for material changes, we’ll notify you (e.g. by email or in the app).</p>
