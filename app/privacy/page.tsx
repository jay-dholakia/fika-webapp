  ...
  return (
    <>
      ...
      <main className="legal-page">
        ...
        <p><strong>Matching.</strong> We use your profile and preferences to find good Fika intros. When relevant, we use your SMS replies (e.g. accept/pass, scheduling responses), your availability, and match status to provide introductions and improve matching.</p>
