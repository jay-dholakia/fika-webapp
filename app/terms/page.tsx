  ...
  return (
    <>
      ...
      <main className="legal-page">
        ...
        <p>
          Welcome to Fika. By using our website or the Fika concierge (including SMS), you agree to these terms. Please read them carefully.
        </p>
        ...
        <h2>The service</h2>
        <p>Fika provides introductions and helps you coordinate meetups in real life. Much of your interaction—weekly opt-in, receiving intros, and confirming times—happens via SMS with your Fika concierge. You can also use our web portal to set your profile, set availability, view intros, and manage your account. We may offer messaging with your match; see our <Link href="/privacy">Privacy Policy</Link> for how we handle that data. We don’t guarantee matches or any particular outcome. The service is provided “as is” to the extent permitted by law.</p>

        <h2>SMS and messaging</h2>
        <p><strong>SMS.</strong> By providing your phone number, you agree to receive SMS from Fika (concierge messages, intros, scheduling, reminders). Message and data rates may apply. You can reply STOP to opt out of these messages. See our <Link href="/privacy">Privacy Policy</Link> for details.</p>
