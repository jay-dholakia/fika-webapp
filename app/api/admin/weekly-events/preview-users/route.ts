...
/** GET /api/admin/weekly-events/preview-users
 *  Same filter params as preview-count; returns the matching user list. */
export async function GET(request: Request) {
  try {
    ...
    const { data: profiles, error: profilesError } = await supabase
      .from('profiles')
      .select('id, first_name, lat, lng, gender, birthdate, avatar_url')
