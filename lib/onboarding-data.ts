...
export const INTAKE_STEPS: ProfileStep[] = [
  ...
  },
  {
    ...
    options: [
      'My work or career',
      "A business or project I'm building",
      'My family or kids',
      'Close friendships',
  ...
  {
    id: 'q_curiosity',
    question: 'What kinds of things sound interesting to learn more about?',
    body: 'Select all that apply.',
    type: 'multi_select',
    options: [
      ...
      'Cities and how places are designed',
      'Entrepreneurship and how businesses are built',
      'Creativity and making things',
      'Psychology and human behavior',
      'History',
      'Science discoveries',
      'Culture and how people live',
  ...
  },
  {
    ...
    question: "What's a place you'd recommend someone visit?",
    body: 'Examples: café, park, restaurant, city, hidden spot',
    type: 'text',
    required: false,
  ...
  },
  {
    ...
    type: 'text',
    required: false,
    placeholder: 'Optional — e.g. politics, work',
  },
  // Block 4 — Perspective
  {
    id: 'q_role_model',
  ...
  },
  {
    ...
    type: 'chips_single',
    required: true,
    options: ["I'm open to meeting someone new for a thoughtful conversation."],
  },
]
